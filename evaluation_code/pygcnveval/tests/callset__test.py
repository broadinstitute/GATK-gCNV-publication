...
TRUTH_CALLSET_VALUES = [('1', 501, 4500, 'DEL_chr1_1', EventType.DEL, frozenset(['SAMPLE_0', 'SAMPLE_1', 'SAMPLE_2']), 0.75, 3),
                        ('1', 7001, 10000, 'DEL_chr1_2', EventType.DEL, frozenset(['SAMPLE_0']), 1./2, 2),
                        ('2', 1001, 3000, 'DUP_chr2_1', EventType.DUP, frozenset(['SAMPLE_0']), 1./2, 0),
                        ('2', 4001, 7000, 'DUP_chr2_2', EventType.DUP, frozenset(['SAMPLE_0', 'SAMPLE_1']), 1./2, 2)]
...
TRUTH_CALLSET_CALLSET_MATRIX_VIEW_GENOTYPES = np.array([[1, 1, 1, 0, 1, 1, 2, 2],
                                                        [1, 1, 1, 0, 0, 0, 2, 2],
                                                        [1, 1, 1, 0, 0, 0, 0, 0]])
...
def test_truth_callset():
    ...
    truth_callset_actual.filter_out_uncovered_events(interval_collection, overall_reciprocal_overlap=0.3)
