...
PER_BIN_EVALUATION_RESULT_EXPECTED.quality_thresholds = [10.0, 60.0, 100.0]
PER_BIN_EVALUATION_RESULT_EXPECTED.true_positives = {10.0: 0, 60.0: 6, 100.0: 7}
PER_BIN_EVALUATION_RESULT_EXPECTED.false_positives = {10.0: 1, 60.0: 3, 100.0: 3}
PER_BIN_EVALUATION_RESULT_EXPECTED.false_negatives = {10.0: 0, 60.0: 3, 100.0: 6}
...
def test_event_evaluator():
    ...
    truth_callset.filter_out_uncovered_events(interval_collection, overall_reciprocal_overlap=0.3)
...
def test_bin_evaluator():
    ...
    evaluation_result_actual = evaluator.evaluate_callset_against_the_truth(gcnv_callset, 3)
